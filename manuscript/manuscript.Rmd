...
We can think of this proportion $\omega$ as akin to an Intraclass Correlation Coefficient focused only on the systematic components of the model while ignoring residual variance that might be attributable to measurement error or non-persisting change [see also the variance decomposition of period and cohort by @vaisey2016]. The higher this proportion is, the more systematic variance in responses is attributable to intrapersonal change during the panel. The lower this proportion, the less intrapersonal change seems to play a large role in explaining systematic cultural differences during the panel. Moving forward, we use $\omega$ as a placeholder for *systematic variance attributable to intrapersonal change*.
