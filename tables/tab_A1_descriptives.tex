...
\caption*{
{\large \textbf{Descriptives of variables}}
} \\ 
\toprule
\multicolumn{1}{l}{} & \emph{\textbf{ω}} & \textbf{Within variance} & \textbf{Between variance} & \textbf{Residual variance} & \textbf{Label} & \textbf{Topic} \\ 
\midrule
